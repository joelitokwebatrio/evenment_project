...
public class Utils {
    ...
    public static final String EVENT_ALREADY_EXIST_IN_DATABASE = "Event Already Exist in Database";
    public static final String PARTICIPANT_ALREADY_EXIST_IN_DATABASE = "Participant Already Exist in Database";
